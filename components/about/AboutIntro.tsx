        ...
        <div className='max-w-screen-xl mx-auto flex flex-wrap justify-center px-2 md:px-6'>
            ...
            <div className="w-full md:w-1/2 px-4">
                <div className="flex flex-col px-4 py-2">
                    ...
                    <p>We like to meet with our couples and offer Complimentary Wedding Consultation that can be done on-line using Google Meet. The couple&apos;s schedules tend to be very busy these days, and we try to save the trips for those who live too far from Des Plaines.</p>
