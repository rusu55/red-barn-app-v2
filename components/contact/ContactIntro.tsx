  ...
  return (
    <div>
      <div className="w-full flex flex-col items-center">
        ...
        <h2 className="w-[90%] text-center py-4">We`d love to tell your story.</h2>
      </div>
      <div className="w-full">
        <p className="mx-2 text-center">We are excited to go wherever your love story is taking us and look forward to hearing from you!</p>
        <div className="pt-6">
             <ul className="mx-auto w-[80%] ">
                <li className="py-2 border-b-2 border-roze flex justify-between items-center"><span className=" uppercase">Phone:</span><span className=" text-lg text-right w-[80%] leading-9">(312) 912-5004</span></li>
                <li className="py-2 border-b-2 border-roze flex justify-between items-center"><span className=" uppercase">Email:</span><span className=" text-lg text-right w-[80%] leading-9">RedBarnBride@yahoo.com</span></li> 
                 
              </ul>
        </div>
        <p className="pt-14 text-center">Please fill out the form or setup an appointment directly with us...</p>
        <div className="text-center py-6">
          <Button href="https://redbarnweddingstudio.setmore.com">Book An Appointment</Button>
        </div>
      </div>
