    ...
    <RevealComponent index={1} variants={fadeBottomTop}>
        <div className="max-w-screen-xl mx-auto flex flex-wrap justify-center items-center pt-12">           
                ...
                <div className="w-full md:w-2/5 px-4">
                    ...
                    <div className="flex flex-col pt-10">
                        <p>Your photos will be delivered between 4-6 weeks after your wedding via online gallery, they will be high resolution, all edited for color and exposure and without any watermarks. You&apos;ll have full reproduction rights to all your photos.</p>
                    </div>
                </div>
