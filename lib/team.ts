export const managers = [
    ...
    title: 'Director of Operations & Photographer',
    details: [
        'With a knack for organization and a passion for perfection, Michael serves as the cornerstone of Red Barn Studio`s operations. As Team Manager, he ensures every aspect of your wedding photography experience is seamless, from initial inquiries to the final delivery of your beautifully captured memories.',
        ' Michael`s dedication to excellence means he`s always a step ahead, coordinating schedules, liaising with photographers, and guaranteeing a personalized experience for each couple. His warm demeanor and attention to detail make him a favorite among clients, while his behind-the-scenes expertise ensures every shoot runs like clockwork.',
        'When he`s not orchestrating unforgettable weddings, Michael enjoys exploring the arts and finding inspiration to bring fresh ideas to the Red Barn Studio team.'
    ]
},
{
    name: 'Bogdan R.',
...
export const employees = [
    ...
    },
    {
        ...
        title: 'Videographer',
        details: [
            'Sergio is a storyteller at heart, capturing the magic of your wedding day through his expert videography. With a passion for crafting cinematic films that highlight every heartfelt moment, Sergio ensures your love story is preserved in motion, creating memories you can relive for a lifetime.',
            'When he`s not behind the camera, Sergio is often planning his next adventure, as his love for traveling fuels his creativity and fresh perspectives. A true gear enthusiast, he`s always exploring the latest in camera technology to bring cutting-edge quality and innovation to his work.',
...
export const editors = [
    {
        name: 'Cristian R.',
        title: 'Editor',
        photo: '/images/team/cristian.jpg',
        details: [
            ' Cristian is a master of detail and creativity, transforming raw wedding moments into stunning visual stories. As one of Red Barn Studio`s talented photo editors, he combines technical expertise with artistic flair to craft images that are as unique as the couples they celebrate.',
            ' With a deep passion for weddings, Cristian thrives on the joy and emotion that each event brings, ensuring that every photo radiates warmth and authenticity. His dedication to creating one-of-a-kind images means no detail goes unnoticed, and every couple receives a gallery that feels personal and unforgettable.',
            ' “Every wedding is a story waiting to be told, and I love bringing those moments to life through artistry and care.”',
        ]
    },
    {
        name: 'Cosmin N.',
